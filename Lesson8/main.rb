...
class MainMenu
  ...
  def add_wagon
    add_pass_wagon if @selected_train.type == 'pass'
    add_cargo_wagon if @selected_train.type == 'cargo'
  ...
  def buy_place
    buy_pass_ticket if @selected_train.type == 'pass'
    buy_cargo_volume if @selected_train.type == 'cargo'
  rescue StandardError => e
    puts e.message
  end
